...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials } = useGLTF('../../../MaleConnector.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <mesh
        material={nodes.Male_Header_Assembly_V18.material}
        geometry={nodes.Male_Header_Assembly_V18.geometry}
...
useGLTF.preload('../../../MaleConnector.gltf')
